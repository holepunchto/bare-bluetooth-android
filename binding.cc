...
struct bare_bluetooth_android_gatt_handle_t {
  ...
  java_global_ref_t<java_object_t<"to/holepunch/bare/bluetooth/GattCallback">> gatt_callback;
};
...
bare_bluetooth_android_central__on_connect(js_env_t *env, js_function_t<void, js_receiver_t, js_handle_t, std::string> function, bare_bluetooth_android_central_t *context, bare_bluetooth_android_central_connect_t *data) {
  ...
  auto *gatt_handle = new bare_bluetooth_android_gatt_handle_t{
    ...
    java_global_ref_t<java_object_t<"to/holepunch/bare/bluetooth/GattCallback">>(jenv, callback)
  };
...
static void
bare_bluetooth_android_on_scan_callback_finalize(java_env_t, java_object_t<"to/holepunch/bare/bluetooth/ScanCallback">, long native_ptr, long tsfn_discover, long tsfn_scan_fail) {
...
static void
bare_bluetooth_android_on_gatt_callback_finalize(java_env_t, java_object_t<"to/holepunch/bare/bluetooth/GattCallback">, long native_ptr, long tsfn_connect, long tsfn_disconnect, long tsfn_connect_fail) {
...
bare_bluetooth_android_on_peripheral_finalize(java_env_t, java_object_t<"to/holepunch/bare/bluetooth/GattCallback">, long native_ptr, long tsfn_services_discover, long tsfn_characteristics_discover, long tsfn_read, long tsfn_write, long tsfn_notify, long tsfn_notify_state, long tsfn_mtu_changed) {
  ...
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_write), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_notify), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_notify_state), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_mtu_changed), js_threadsafe_function_release);

  auto *peripheral = reinterpret_cast<bare_bluetooth_android_peripheral_t *>(native_ptr);
  if (--peripheral->ref_count == 0) {
    delete peripheral;
  }
}
...
bare_bluetooth_android_peripheral_init(
  ...
  js_acquire_threadsafe_function(peripheral->tsfn_services_discover);
  js_acquire_threadsafe_function(peripheral->tsfn_characteristics_discover);
  js_acquire_threadsafe_function(peripheral->tsfn_read);
  js_acquire_threadsafe_function(peripheral->tsfn_write);
  js_acquire_threadsafe_function(peripheral->tsfn_notify);
  js_acquire_threadsafe_function(peripheral->tsfn_notify_state);
  js_acquire_threadsafe_function(peripheral->tsfn_mtu_changed);
  peripheral->ref_count++;

  {
    auto gatt_callback = java_object_t<"to/holepunch/bare/bluetooth/GattCallback">(jenv, gatt_handle->gatt_callback);
    auto set_peripheral_tsfns = gatt_callback.get_class().get_method<void(long, long, long, long, long, long, long, long)>("setPeripheralTsfns");
    set_peripheral_tsfns(gatt_callback, reinterpret_cast<long>(peripheral), reinterpret_cast<long>(peripheral->tsfn_services_discover), reinterpret_cast<long>(peripheral->tsfn_characteristics_discover), reinterpret_cast<long>(peripheral->tsfn_read), reinterpret_cast<long>(peripheral->tsfn_write), reinterpret_cast<long>(peripheral->tsfn_notify), reinterpret_cast<long>(peripheral->tsfn_notify_state), reinterpret_cast<long>(peripheral->tsfn_mtu_changed));
  }
...
static void
bare_bluetooth_android_peripheral__on_l2cap_open_complete(js_env_t *env, js_function_t<void>, bare_bluetooth_android_peripheral_l2cap_open_req_t *, bare_bluetooth_android_peripheral_l2cap_open_complete_t *data) {
...
bare_bluetooth_android_peripheral_release(bare_bluetooth_android_peripheral_t *peripheral) {
  ...
  // Release global refs so BluetoothGatt can be GC'd, which allows GattCallback
  // to be GC'd and its finalize() to run
  peripheral->gatt = {};
  peripheral->device = {};
...
bare_bluetooth_android_server_init(
  ...
  js_acquire_threadsafe_function(server->tsfn_server_connection_state);
  js_acquire_threadsafe_function(server->tsfn_add_service);
  js_acquire_threadsafe_function(server->tsfn_read_request);
  js_acquire_threadsafe_function(server->tsfn_write_request);
  js_acquire_threadsafe_function(server->tsfn_descriptor_response);
  js_acquire_threadsafe_function(server->tsfn_subscribe);
  js_acquire_threadsafe_function(server->tsfn_unsubscribe);
  js_acquire_threadsafe_function(server->tsfn_notify_sent);
  server->ref_count++;

  {
    auto set_tsfns = callback_local.get_class().get_method<void(long, long, long, long, long, long, long, long)>("setTsfns");
    set_tsfns(callback_local, reinterpret_cast<long>(server->tsfn_server_connection_state), reinterpret_cast<long>(server->tsfn_add_service), reinterpret_cast<long>(server->tsfn_read_request), reinterpret_cast<long>(server->tsfn_write_request), reinterpret_cast<long>(server->tsfn_descriptor_response), reinterpret_cast<long>(server->tsfn_subscribe), reinterpret_cast<long>(server->tsfn_unsubscribe), reinterpret_cast<long>(server->tsfn_notify_sent));
  }
...
bare_bluetooth_android_server_release(bare_bluetooth_android_server_t *server) {
  ...
  // Release global refs so Java objects can be GC'd, which allows
  // GattServerCallback finalize() to run
  server->gatt_server = {};
  server->adapter = {};
  server->advertiser = {};
  server->advertise_callback = {};
...
static void
bare_bluetooth_android_on_gatt_server_callback_finalize(java_env_t, java_object_t<"to/holepunch/bare/bluetooth/GattServerCallback">, long native_ptr, long tsfn_connection_state, long tsfn_add_service, long tsfn_read_request, long tsfn_write_request, long tsfn_descriptor_response, long tsfn_subscribe, long tsfn_unsubscribe, long tsfn_notify_sent) {
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_connection_state), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_add_service), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_read_request), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_write_request), js_threadsafe_function_release);
  js_release_threadsafe_function(reinterpret_cast<js_threadsafe_function_t *>(tsfn_descriptor_response), js_threadsafe_function_release);
...
bare_bluetooth_android_register_natives() {
...

  {
    ...
    cls.register_natives(
      ...
      java_native_method_t<bare_bluetooth_android_on_gatt_server_callback_finalize>("nativeOnFinalize")
    );
  }

  {
    ...
    cls.register_natives(
      ...
      java_native_method_t<bare_bluetooth_android_on_peripheral_finalize>("nativeOnPeripheralFinalize")
    );
  }
